...
import base_feature.utils.watchers.KeyboardEventListener
import com.matheussilas97.base_feature.R
import com.metheussilas97.domain.exception.DataSourceException
...
abstract class BaseFragment<Binding : ViewBinding> : Fragment(), ViewStateListener, KoinComponent {
    ...
    open fun showErrorDialog(
        ...
        GenericErrorBottomSheet.newInstance(
            ...
            description = description ?: getString(R.string.generic_error_description),
